...
namespace SuperFantasyMagicProject
{
    ...
    {
        private static int baseHealth = 250;
        private static int baseMana = 80;
        ...
        private static int maxHealth = baseHealth + Strength * 10;
        ...
        private static int damage = strength * 2;
